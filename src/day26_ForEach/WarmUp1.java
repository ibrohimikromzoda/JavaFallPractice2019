...
public class WarmUp1 {
	public static void main(String[] args) {
		...
		/*
		 * // solution 2: String Str1 = "cccccaaaabbbbcccd" , Str2 = "cccaaabbb";
		 * 
		 * Str1 = new TreeSet<String>( Arrays.asList( Str1.split(""))).toString(); Str2
		 * = new TreeSet<String>( Arrays.asList( Str2.split(""))).toString();
		 * 
