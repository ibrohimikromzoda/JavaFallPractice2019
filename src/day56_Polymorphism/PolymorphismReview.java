...
public class PolymorphismReview{
	public static void main(String[] args) {
		...
		// B obj3 = new A(); // child class cannot be the reference to parent class'
		// object.
		...
		// if a method is exist in both reference type and object, the overridden one
		// gets executed

		obj11.methodC();
		// if the method is not being overriddedn, then the reference type' method gets
		// executed
