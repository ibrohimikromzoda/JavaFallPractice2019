...
public class WrapperClassMethods {
	...
	public static void main(String[] args) {
		...
		// max_Value : returns the maximum value of primitive
		...
		// min_Value : returns the minumum value of primitive
		...
		// parse methods : converts String values to primitives, returns primitives values.
		...
		// byte num3 = Byte.parseByte ("18"); // out of range
		
		int num3 = Byte.parseByte("18"); // none
		...
		int num7 = (int) Long.parseLong("1222"); // none
	...
	System.out.println(num11);
		...
		//ValueOf methods : converts String value to Wrapper class values, returns wrapper class value
