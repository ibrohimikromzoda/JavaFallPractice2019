...
public class Static_VS_insVs_Cons {
	...
	public static void main(String[] args) {
		Static_VS_insVs_Cons obj = new Static_VS_insVs_Cons();
		Static_VS_insVs_Cons obj2 = new Static_VS_insVs_Cons();
		Static_VS_insVs_Cons obj3 = new Static_VS_insVs_Cons();
